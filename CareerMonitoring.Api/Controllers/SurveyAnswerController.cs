    ...
    public class SurveyAnswerController : ApiUserController {
        ...
        public async Task<IActionResult> CreateSurveyAnswer ([FromBody] SurveyAnswerToAdd command) {
            ...
            foreach (var questionAnswer in command.Questions) {
                ...
                // int questionAnswerId = await _surveyAnswerService.AddQuestionAnswerToSurveyAnswerAsync (surveyAnswerId, questionAnswer.QuestionPosition,
                ...
                //                 choiceOption.OptionPosition, choiceOption.Value, choiceOption.ViewValue);
                //             }
                //         }
                //     }
