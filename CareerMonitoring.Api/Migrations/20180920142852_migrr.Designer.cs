...
namespace CareerMonitoring.Api.Migrations
{
    ...
    [Migration("20180920142852_migrr")]
    partial class migrr
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CareerMonitoring.Core.Domains.SurveyReport.ChoiceOptionReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int>("OptionCounter");
            ...
            modelBuilder.Entity("CareerMonitoring.Core.Domains.SurveyReport.RowChoiceOptionReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasIndex("RowReportId");

                    b.ToTable("RowChoiceOptionReports");
                });

            modelBuilder.Entity("CareerMonitoring.Core.Domains.SurveyReport.RowReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("RowPostion");

                    b.HasKey("Id");

                    b.HasIndex("QuestionReportId");

                    b.ToTable("RowReports");
                });
            ...
            modelBuilder.Entity("CareerMonitoring.Core.Domains.SurveyReport.SurveyReport", b =>
                {
                    ...
                    b.Property<int>("SurveyAnswersNumber");

                    b.Property<int>("SurveyId");

                    b.Property<int>("SurveyRecepientsNumber");
            ...
            modelBuilder.Entity("CareerMonitoring.Core.Domains.SurveyScore.ChoiceOptionScore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("ChoiceScores");
                });

            modelBuilder.Entity("CareerMonitoring.Core.Domains.SurveyScore.FieldDataScore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("FieldDataScores");
                });

            modelBuilder.Entity("CareerMonitoring.Core.Domains.SurveyScore.QuestionScore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CareerMonitoring.Core.Domains.SurveyReport.RowChoiceOptionReport", b =>
                {
                    b.HasOne("CareerMonitoring.Core.Domains.SurveyReport.RowReport", "RowReport")
                        .WithMany("RowChoiceOptionReports")
                        .HasForeignKey("RowReportId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("CareerMonitoring.Core.Domains.SurveyScore.FieldDataScore", b =>
                {
                    b.HasOne("CareerMonitoring.Core.Domains.SurveyScore.QuestionScore", "Question")
                        .WithMany("FieldData")
                        .HasForeignKey("QuestionId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("CareerMonitoring.Core.Domains.SurveyScore.QuestionScore", b =>
                {
                    b.HasOne("CareerMonitoring.Core.Domains.SurveyScore.SurveyScore", "Survey")
                        .WithMany("Questions")
                        .HasForeignKey("SurveyId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
